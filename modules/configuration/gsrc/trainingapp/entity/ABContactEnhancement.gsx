  ...
  */
  ...
  property get Age(): int{
    if(this typeis ABPerson){
      if(((this as ABPerson).DateOfBirth) != null){
        var dob = (this as ABPerson).DateOfBirth
        var today = DateUtil.currentDate()
        var dias = DateUtil.daysBetween(dob, today);
        var year = gw.api.util.Math.roundDown(dias/365)
        return year as int
      }
      return 0
    }
